...
//  SDULife
//
//  Created by Bakdaulet on 12.02.2022.
//
        ...
        HStack() {
            VStack(alignment: .center){
                if self.data.showDone {
                    ...
                    ActivityIndicatorr(isAnimating: .constant(true), style: .large)
                }
...
@available(iOS 13.0, macOS 10.15, *)
struct ActivityIndicatorr: UIViewRepresentable {
    
    @Binding var isAnimating: Bool
    let style: UIActivityIndicatorView.Style
    
    func makeUIView(context: UIViewRepresentableContext<ActivityIndicatorr>) -> UIActivityIndicatorView {
        return UIActivityIndicatorView(style: style)
    }
    
    func updateUIView(_ uiView: UIActivityIndicatorView, context: UIViewRepresentableContext<ActivityIndicatorr>) {
